...
|------|----------------|----------------------|-------|
| `researcher` | `hive/agents/researcher.md` | See template below | Read-only by default; may write to `state/` and `hive/memory/` |
...
| `tester` | `hive/agents/test-architect.md` | See template below | Write access scoped to `tests/` and `state/` |
| `reviewer` | `hive/agents/reviewer.md` | See template below | Read-only; writes review artifacts to `state/episodes/` |
...
|------|----------------------|
| `researcher` | `state/`, `hive/memory/` |
| `backend-developer` | `src/`, `lib/`, `api/`, `state/` |
| `frontend-developer` | `src/`, `components/`, `pages/`, `styles/`, `state/` |
| `tester` | `tests/`, `__tests__/`, `spec/`, `state/` |
| `reviewer` | `state/episodes/` |
